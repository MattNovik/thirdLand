...
var photosSlider = document.querySelector("#reviews");
var swiperPhotos;
var initPhotosSwiper = function initPhotosSwiper(slider, loop) {
...
/* harmony import */ var _init_swiper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./init-swiper */ "./js/init-swiper.js");
/* harmony import */ var _modules_init_mob_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-mob-menu */ "./js/modules/init-mob-menu.js");
/* harmony import */ var _modules_init_form_steps__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-form-steps */ "./js/modules/init-form-steps.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    ...
    window.form = form;
    form.init();
    Object(_init_swiper__WEBPACK_IMPORTED_MODULE_4__["initPhotosSlider"])();
    Object(_modules_init_mob_menu__WEBPACK_IMPORTED_MODULE_5__["initMenuOpener"])();
    Object(_modules_init_form_steps__WEBPACK_IMPORTED_MODULE_6__["initFormSteps"])();
  });
});
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("https://dev.studservis.ru/wp-content/themes/studservice/ajax/createOrder.php", formData, {
    auth: {
      username: "admin",
    ...
    if (response.order_id && response.action === "userIsset") {
      return window.location.href = "https://studservis-lk.ru/" + "orders/newOrder/id=" + response.order_id + "/new/";
    } else {
      return window.location.href = "https://studservis-lk.ru/";
    }
  }).catch(function (error) {
    event.target.querySelector("button[type='submit'").setAttribute("disabled", "false");
    console.log("error");
  });
...
/*!***************************************!*\
  !*** ./js/modules/init-form-steps.js ***!
  \***************************************/
/*! exports provided: initFormSteps */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFormSteps", function() { return initFormSteps; });
var formWrapper = document.querySelector(".custom-form.first-form");
var initFormSteps = function initFormSteps() {
  if (formWrapper) {
    var firstStepInput = formWrapper.querySelector(".custom-form__input--theme input");
    var firstStepInputWrapper = formWrapper.querySelector(".custom-form__input--theme");
    var firstStepButton = formWrapper.querySelector(".custom-form__button--next");
    var secondStepInputWrapper = formWrapper.querySelector(".custom-form__input--first-email");
    var secondStepButton = formWrapper.querySelector(".custom-form__button--last");
    firstStepInputWrapper.classList.contains("visibility-hidden") ? firstStepInput.classList.remove("visibility-hidden") : null;
    firstStepButton.classList.contains("visibility-hidden") ? firstStepButton.classList.remove("visibility-hidden") : null;
    !secondStepInputWrapper.classList.contains("visibility-hidden") ? secondStepInputWrapper.classList.add("visibility-hidden") : null;
    !secondStepButton.classList.contains("visibility-hidden") ? secondStepButton.classList.add("visibility-hidden") : null;
...
/*!*************************************!*\
  !*** ./js/modules/init-mob-menu.js ***!
  \*************************************/
/*! exports provided: initMenuOpener */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMenuOpener", function() { return initMenuOpener; });
...
var initMenuOpener = function initMenuOpener() {
  burger.addEventListener("click", handleOpenMenu);
  Array.from(menuItems).map(function (item) {
    return item.addEventListener("click", handleCloseMenu);
  });
  Array.from(menuLinks).map(function (item) {
    return item.addEventListener("click", handleCloseMenu);
  });
  var buttonEnterFromMenu = document.querySelector(".menu__enter");
